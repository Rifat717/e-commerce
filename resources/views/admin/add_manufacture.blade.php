						...
						<form class="form-horizontal" action="{{url ('/save-manufacture') }}" method="post">
						  ...
						  <fieldset>
							...
							<div class="control-group col-md-12">
							  <label class="control-label col-md-4" for="date01">Manufacture Name</label>
							  <div class="controls">
								<input type="text" class="input-xlarge col-md-8" name="manufacture_name" required>
							  </div>
							</div>

							         
							<div class="control-group col-md-12">
							  <label class="control-label col-md-4" for="textarea2">Manufacture Desription</label>
							  <div class="controls">
